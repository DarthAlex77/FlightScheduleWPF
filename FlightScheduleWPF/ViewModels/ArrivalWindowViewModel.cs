...
{
    public class ArrivalWindowViewModel : ViewModelBase
    {
        private readonly object _lock;
        private readonly int    _numberOfWindow;
        private          int    _countOfFlights;

        public ArrivalWindowViewModel(int numberOfWindow)
        {
